...
public sealed class CreateRecurringTemplateRequestValidator : AbstractValidator<CreateRecurringTemplateRequest>
{
    ...
    private static bool HasDayOfMonthOrUseLastDay(CreateRecurringTemplateRequest x)
    {
