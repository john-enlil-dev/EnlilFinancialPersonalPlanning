...
public sealed class SimpleAssetConfiguration : IEntityTypeConfiguration<SimpleAsset>
{
    public void Configure(EntityTypeBuilder<SimpleAsset> builder)
    {
        builder.ToTable("SimpleAssets");
